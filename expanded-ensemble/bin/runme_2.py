...
def get_pipeline(instance, iterations):
    ...
    for it in range(1, iterations+1):
        ...
        t3.download_output_data = [ 'CB7G3.xtc > ./output/CB7G3_run{1}_gen{0}.xtc'.format(it, instance),
                                   'CB7G3.log > ./output/CB7G3_run{1}_gen{0}.log'.format(it,instance),
                                   'CB7G3_dhdl.xvg > ./output/CB7G3_run{1}_gen{0}_dhdl.xvg'.format(it,instance),
                                   'CB7G3_pullf.xvg > ./output/CB7G3_run{1}_gen{0}_pullf.xvg'.format(it,instance),
                                   'CB7G3_pullx.xvg > ./output/CB7G3_run{1}_gen{0}_pullx.xvg'.format(it,instance),
